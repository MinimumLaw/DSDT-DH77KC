DefinitionBlock ("DSDT.aml", "DSDT", 2, "INTEL ", "DH77KC  ", 0x0000006A)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xDEBBFE18, 0x01CD)
...
/*FixMe: Is this correct?*/ 0x02,               // Length
                    ...
                    Method (_CRS, 0, NotSerialized)
                    {
                        ...
                        If (IO2B)
                        {
                            CreateWordField (CRS, \_SB.PCI0.LPCB.SIO1._Y13._MIN, GP30)
                            CreateWordField (CRS, \_SB.PCI0.LPCB.SIO1._Y13._MAX, GP31)
                            CreateByteField (CRS, \_SB.PCI0.LPCB.SIO1._Y13._LEN, GPL3)
                            Store (IO2B, GP30)
                            Store (IO2B, GP31)
                            Store (IO2L, GPL3)
                        }
                    ...
                    Method (DSTA, 1, NotSerialized)
                    {
                        ...
                        Else
                        {
                            ...
                            Else
                            {
                                ...
                                Or (ShiftLeft (IOH2, 0x08), IOL2, Local0)
                                If (Local0)
                                {
                                    Return (0x0D)
                                }
...
/* Resource fill function finish */
                    ...
                    Method (_CRS, 0, NotSerialized)
                    {
                        Name (BUF1, ResourceTemplate ()
                        {
                            ...
                            IRQ (Edge, ActiveHigh, Shared, )
                                {3}
                            IO (Decode10,
                                0x0A50,             // Range Minimum
                                0x0A50,             // Range Maximum
                                0x00,               // Alignment
                                0x10,               // Length
                                )
                        })
        ...
        Scope (\_GPE)
        {
            ...
            Method (_L0B, 0, NotSerialized)
            {
                ...
                Notify (\_SB.PCI0.RP08.BR21, 0x02)
                Notify (\_SB.PWRB, 0x02)
            }
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xDEAA5E18, 0x10)
        ...
        OperationRegion (GPE0, SystemIO, GPER, 0x08)
    ...
    Scope (_SB.PCI0)
    {
        Device (PDRC)
        {
            ...
            Method (_CRS, 0, Serialized)
            {
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y1D._BAS, RBR0)
                ShiftLeft (^^LPCB.RCBA, 0x0E, RBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y1E._BAS, TBR0)
                Store (TBAB, TBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y1E._LEN, TBLN)
                If (LEqual (TBAB, Zero))
                {
                    Store (Zero, TBLN)
                }
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y1F._BAS, MBR0)
                ShiftLeft (MHBR, 0x0F, MBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y20._BAS, DBR0)
                ShiftLeft (DIBR, 0x0C, DBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y21._BAS, EBR0)
                ShiftLeft (EPBR, 0x0C, EBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y22._BAS, XBR0)
                ShiftLeft (PXBR, 0x1A, XBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y22._LEN, XSZ0)
    ...
    Scope (_SB)
    {
        Name (LUCD, Buffer (0x7D)
        {
            ...
            /* 0010 */   0x00, 0x00, 0x00, 0xBE, 0x74, 0x64, 0x30, 0x31,
            ...
            /* 0030 */   0x33, 0x33, 0x63, 0x65, 0x36, 0x62, 0x31, 0x39,
            /* 0038 */   0x65, 0x62, 0x32, 0x39, 0x64, 0x36, 0x30, 0x34,
            /* 0040 */   0x66, 0x65, 0x63, 0x36, 0x38, 0x36, 0x62, 0x33,
            /* 0048 */   0x37, 0x65, 0x61, 0x64, 0x30, 0x63, 0x63, 0x61,
            /* 0050 */   0x63, 0x32, 0x62, 0x31, 0x31, 0x30, 0x30, 0x30,
            /* 0058 */   0x30, 0x32, 0x35, 0x41, 0x36, 0x63, 0x65, 0x64,
